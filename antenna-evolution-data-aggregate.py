...
# Folium map
map_latest = folium.Map([rennes_latitude, rennes_longitude], tiles='stamentoner', zoom_start=13)
for loc in antennas['location']:
    folium.CircleMarker([loc[0],loc[1]],radius=3,fill_color="#3db7e4",fill_opacity=1).add_to(map_latest)
...
map_2013 = folium.Map([rennes_latitude, rennes_longitude], tiles='stamentoner', zoom_start=13)
for loc in antennas_2013['location']:
    folium.CircleMarker([loc[0],loc[1]],radius=3,fill_color="#3db7e4",fill_opacity=1).add_to(map_2013)
